#ifndef INFERNO_PYTHON_EHC_FACTORY
#define INFERNO_PYTHON_EHC_FACTORY

#include "../exportInference.hxx"

#ifdef WITH_QPBO
#include "inferno/inference/ehc.hxx"
#endif
...
namespace inference{
    ...
    struct ExportInferenceFactory<Ehc<MODEL> >{

        typedef Ehc<MODEL> Inference;
...
#endif // INFERNO_PYTHON_EHC_FACTORY
