###################################################################
#
# INFERNO_ADD_NUMPY_MODULE: setup a module dependening on inferno_python
#
# INFERNO_ADD_NUMPY_MODULE(modulename [SOURCES] source1.cpp, source2.cpp ...
...
#   
#        If VIGRANUMPY is given, the module is considered part of 'inferno_python' and will
#        be compiled and installed along with the other inferno_python modules (otherwise,
...
FUNCTION(INFERNO_ADD_NUMPY_MODULE target_with_prefix)
    ...
    SET(target_tmp_path   ${inferno_python_tmp_dir}/${target_dir_prefix})
    MESSAGE(STATUS "inferno_python_tmp_dir "${inferno_python_tmp_dir})
    ...
    IF(PART_OF_VIGRANUMPY)
        set(TARGET_NAME inferno_python_${target})
    ...
    IF(PART_OF_VIGRANUMPY)
        ADD_DEPENDENCIES(inferno_python ${TARGET_NAME})
        ...
        GET_TARGET_PROPERTY(VIGRANUMPY_DEPENDS inferno_python VIGRA_DEPENDS)
        IF(NOT VIGRANUMPY_DEPENDS)
            set(VIGRANUMPY_DEPENDS "")
        ENDIF()
        SET_TARGET_PROPERTIES(inferno_python PROPERTIES VIGRA_DEPENDS "${VIGRANUMPY_DEPENDS} ${TARGET_NAME}")
    ENDIF()
    ...
    IF(PART_OF_VIGRANUMPY)
        ...
        # create a temporary inferno_python installation in ${vigranumpy_tmp_dir}
    ...
    ENDIF()
ENDFUNCTION(INFERNO_ADD_NUMPY_MODULE)
