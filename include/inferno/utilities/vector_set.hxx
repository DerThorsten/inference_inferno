...
/** \brief set with O(n) insert and O(1) access

    \tparam Key key and value type of the set
    \tparam Alloc allocator of the set

    VectorSet has the same interface as std::set.
...
public:
   ...
   // memeber functions:
   // constructor
   VectorSet(const size_t, const Compare& compare=Compare(), const Alloc& alloc=Alloc());
   VectorSet(const Compare& compare=Compare(), const Alloc& alloc=Alloc());
   template <class InputIterator>
      VectorSet(InputIterator, InputIterator, const Compare& compare =Compare(), const Alloc & alloc=Alloc());
...
inline
VectorSet<Key,Compare,Alloc>::VectorSet
(
...
template<class Key, class Compare, class Alloc>
inline const typename VectorSet<Key,Compare,Alloc>::value_type&
VectorSet<Key,Compare,Alloc>::operator[]
(
   const typename VectorSet<Key,Compare,Alloc>::size_type  index
) const
{
...
VectorSet<Key,Compare,Alloc>::VectorSet
(
   const VectorSet<Key,Compare,Alloc>& src
)
:  vector_(src.vector_),
...
/// \param src other random access set
template<class Key, class Compare, class Alloc>
inline VectorSet<Key,Compare,Alloc>&
VectorSet<Key,Compare,Alloc>::operator=
(
   const VectorSet<Key,Compare,Alloc> & src
)
...
template<class Key, class Compare, class Alloc>
inline typename VectorSet<Key,Compare,Alloc>::const_iterator
VectorSet<Key,Compare,Alloc>::begin() const
{
...
template<class Key, class Compare, class Alloc>
inline typename VectorSet<Key,Compare,Alloc>::const_iterator
VectorSet<Key,Compare,Alloc>::end() const
{
    return vector_.end();
}
...
template<class Key, class Compare, class Alloc>
inline typename VectorSet<Key,Compare,Alloc>::const_iterator
VectorSet<Key,Compare,Alloc>::rbegin() const
{
...
template<class Key, class Compare, class Alloc>
inline typename VectorSet<Key,Compare,Alloc>::const_iterator
VectorSet<Key,Compare,Alloc>::rend() const
{
    return vector_.rend();
}
...
template<class Key, class Compare, class Alloc>
inline typename VectorSet<Key,Compare,Alloc>::iterator
VectorSet<Key,Compare,Alloc>::begin()
{
   return vector_.begin();
}
...
template<class Key, class Compare, class Alloc>
inline typename VectorSet<Key,Compare,Alloc>::iterator
VectorSet<Key,Compare,Alloc>::end()
{
    return vector_.end();
}
...
template<class Key, class Compare, class Alloc>
inline typename VectorSet<Key,Compare,Alloc>::iterator
VectorSet<Key,Compare,Alloc>::rbegin()
{
   return vector_.rbegin();
}
...
template<class Key, class Compare, class Alloc>
inline typename VectorSet<Key,Compare,Alloc>::iterator
VectorSet<Key,Compare,Alloc>::rend()
{
    return vector_.rend();
}
...
template<class Key, class Compare, class Alloc>
inline bool
VectorSet<Key,Compare,Alloc>::empty() const
{
...
template<class Key, class Compare, class Alloc>
inline typename VectorSet<Key,Compare,Alloc>::size_type
VectorSet<Key,Compare,Alloc>::size() const
{
   return vector_.size();
}
...
template<class Key, class Compare, class Alloc>
inline typename VectorSet<Key,Compare,Alloc>::size_type
VectorSet<Key,Compare,Alloc>::max_size() const
{
...
/// set
template<class Key, class Compare, class Alloc>
inline std::pair<typename VectorSet<Key,Compare,Alloc>::const_iterator,bool>
VectorSet<Key,Compare,Alloc>::insert
(
   const typename VectorSet<Key,Compare,Alloc>::value_type& value
) {
   bool found(true);
...
VectorSet<Key,Compare,Alloc>::insert
(
   typename VectorSet<Key,Compare,Alloc>::const_iterator position,
   const typename VectorSet<Key,Compare,Alloc>::value_type& value
)
{
...
template<class Key, class Compare, class Alloc>
inline void
VectorSet<Key,Compare,Alloc>::erase
(
   typename VectorSet<Key,Compare,Alloc>::iterator position
)
{
...
VectorSet<Key,Compare,Alloc>::erase
(
   const typename VectorSet<Key,Compare,Alloc>::key_type& x
)
{
   iterator i =find(x);
   if(i!=vector_.end())
...
VectorSet<Key,Compare,Alloc>::erase
(
   const typename VectorSet<Key,Compare,Alloc>::const_iterator first,
   const typename VectorSet<Key,Compare,Alloc>::const_iterator last
)
{
...
template<class Key, class Compare, class Alloc>
inline void
VectorSet<Key,Compare,Alloc>::swap
(
...
template<class Key, class Compare, class Alloc>
inline typename VectorSet<Key,Compare,Alloc>::key_compare
VectorSet<Key,Compare,Alloc>::key_comp() const
{
   return compare_;
}
...
template<class Key, class Compare, class Alloc>
inline typename VectorSet<Key,Compare,Alloc>::value_compare
VectorSet<Key,Compare,Alloc>::value_comp() const
{
   return compare_;
}
...
template<class Key, class Compare, class Alloc>
inline typename VectorSet<Key,Compare,Alloc>::const_iterator
VectorSet<Key,Compare,Alloc>::find
(
   const typename VectorSet<Key,Compare,Alloc>::key_type& value
) const
{
...
template<class Key, class Compare, class Alloc>
inline typename VectorSet<Key,Compare,Alloc>::size_type
VectorSet<Key,Compare,Alloc>::count
(
   const typename VectorSet<Key,Compare,Alloc>::key_type&  value
) const
{
...
template<class Key, class Compare, class Alloc>
inline typename VectorSet<Key,Compare,Alloc>::const_iterator
VectorSet<Key,Compare,Alloc>::lower_bound
(
   const typename VectorSet<Key,Compare,Alloc>::key_type& value
) const
{
...
template<class Key, class Compare, class Alloc>
inline typename VectorSet<Key,Compare,Alloc>::const_iterator
VectorSet<Key,Compare,Alloc>::upper_bound
(
   const typename VectorSet<Key,Compare,Alloc>::key_type& value
) const
{
...
template<class Key, class Compare, class Alloc>
inline std::pair<typename VectorSet<Key,Compare,Alloc>::const_iterator,typename VectorSet<Key,Compare,Alloc>::const_iterator>
VectorSet<Key,Compare,Alloc>::equal_range
(
   const typename VectorSet<Key,Compare,Alloc>::key_type& value
) const
{
...
/// \return iterator pair to lower equal range
template<class Key, class Compare, class Alloc>
inline std::pair<typename VectorSet<Key,Compare,Alloc>::iterator,typename VectorSet<Key,Compare,Alloc>::iterator>
VectorSet<Key,Compare,Alloc>::equal_range
(
   const typename VectorSet<Key,Compare,Alloc>::key_type& value
)
...
/// \return allocator
template<class Key, class Compare, class Alloc>
inline typename VectorSet<Key,Compare,Alloc>::allocator_type
VectorSet<Key,Compare,Alloc>::get_allocator() const
{
...
#endif // INFERNO_UTILITIES_VECTOR_SET_HXX
