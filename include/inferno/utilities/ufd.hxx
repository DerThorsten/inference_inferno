#ifndef INFERNO_UTILITIES_UFD_HXX
#define INFERNO_UTILITIES_UFD_HXX
...
/// Reset a Ufd such that each set contains precisely one element
///
/// \param size Number of distinct sets.
///
template<class T>
...
///
template<class T>
inline typename Ufd<T>::value_type
Ufd<T>::find
(
...
#endif // #ifndef INFERNO_UTILITIES_UFD_HXX
